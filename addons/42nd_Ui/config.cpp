...
class CfgPatches
{
	class 42nd_SOC_UI
	{
		...
		requiredAddons[]=
		{
			...
			"A3_Structures_F_Argo_Commercial",
			...
			"A3_Structures_F_Argo_Infrastructure",
			...
			"A3_Structures_F_Argo_Signs",
			"A3_Structures_F_Argo_Signs_City",
			"A3_Structures_F_Argo_Signs_Directions",
			"A3_Structures_F_Argo_Signs_Warnings",
			"A3_Structures_F_Argo_Walls",
			...
			"A3_Dubbing_F_Orange",
			"A3_EditorPreviews_F_Orange",
			"A3_Functions_F_Orange",
			"A3_LanguageMissions_F_Orange",
			"A3_Language_F_Orange",
		...
		class TopRight: RscControlsGroup
		{
			class controls
			{
				class CA_PlayerName: RscText
				{
					...
					w="-100 *      (   ((safezoneW / safezoneH) min 1.2) / 40)";
					h="-100 *      (   (   ((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";

...
class RscDisplayMain: RscStandardDisplay
{
	class controls
	{
		...
		{
			text="\vtn_core_ui\logo\vtn_logo.paa";
			tooltip="";
...
class CfgMods
{
	...
	class VTN: Mod_Base
	{
		picture="\vtn_core_ui\logo\vtn_logo.paa";
		logo="\vtn_core_ui\logo\vtn_logo.paa";
		logoOver="\vtn_core_ui\logo\vtn_logo.paa";
		logoSmall="\vtn_core_ui\logo\vtn_logo_mini.paa";
		tooltip="$STR_DN_VTNmod";
		tooltipOwned="$STR_DN_VTN";
		action="";
		fieldManualTopicAndHint[]={};
		dlcColor[]={0.34999999,0.34999999,0.1,1};
		overview="$STR_DN_VTNmod";
		hideName=1;
		hidePicture=0;
		name="$STR_DN_VTNmod";
		author="$STR_DN_VTN";
		overviewPicture="\vtn_core_ui\logo\vtn_logo.paa";
		overviewText="$STR_DN_VTNmod";
		contentBrowserPicture="\vtn_core_ui\logo\vtn_logo_mini.paa";
		popupMsgPicture="\vtn_core_ui\logo\vtn_logo.paa";
		popupMsgText="$STR_DN_VTNmod";
		vehPrevMsgText="$STR_DN_VTNmod";
		vehPrevNotifText="$STR_DN_VTNmod";
		itemPrevNotifText="$STR_DN_VTNmod";
		dronePrevNotifText="$STR_DN_VTNmod";
		weaponPrevMsgText="$STR_DN_VTNmod";
		dir="@vtn";
		infoPages[]=
		{
			"\vtn_core_ui\logo\vtn_logo.paa"
		};
		overviewFootnote="$STR_DN_VTNmod";
	};
	author="";
	timepacked="1531070099";
};
